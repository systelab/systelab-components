...
Use the **.row** class to display a series of labels, form controls, and buttons on a single horizontal row. Form controls within inline forms vary slightly from their default states.
...
<form class="row justify-content-end">
    <label for="valueToSearch" class="me-2">Find by </label>
    <input type="text" class="form-control" #valueToSearch>
</form>
```

In that case, **.ms-auto** aligns the components on the right.
