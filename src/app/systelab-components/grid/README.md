...
| noRowsText | string | No Rows To Show | String/Template to display in the grid if the grid hasn't got values (can be html) |
| loadingText | string | Loading... | String/Template to display in the grid while the grid is loading the data (can be html) |
