...
@Directive()
export abstract class AbstractApiTreeComboBox<T> extends AbstractComboBox<ComboTreeNode<T>>
	...
	public getInstance(): ComboTreeNode<T> {
		...
		this.columnDefs = [
			{
				...
				cellRenderer: (params: any) => this.getLabelForLevel(params.data)
			}
		];
