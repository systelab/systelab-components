import { ComponentFactory, ComponentFactoryResolver, ComponentRef, Injector, ReflectiveInjector, ResolvedReflectiveProvider, ViewContainerRef } from '@angular/core';
...
export function createComponent(instructions: CreateComponentArgs): ComponentRef<any> {
	...
	const cmpFactory: ComponentFactory<any> = injector.get(ComponentFactoryResolver)
		.resolveComponentFactory(instructions.component);
