export const THEMES = {
	default: {
		...
		'primary':                             'rgb(0, 100, 209)',
		'success':                             'rgb(194, 217, 93)',
		'warning':                             'rgb(255, 210, 54)',
		'danger':                              'rgb(255, 73, 68)',
		'info':                                'rgb(178, 140, 232)',
		'secondary':                           'rgb(170, 170, 170)',
		'primary_light':                       'rgb(0, 100, 209, 0.25)',
		'primary_lighter':                     'rgb(0, 100, 209, 0.1)',
		'success_light':                       'rgb(194, 217, 93, 0.25)',
		'success_lighter':                     'rgb(194, 217, 93, 0.1)',
		'warning_light':                       'rgb(255, 210, 54, 0.25)',
		'warning_lighter':                     'rgb(255, 210, 54, 0.1)',
		'danger_light':                        'rgb(255, 73, 68, 0.25)',
		'danger_lighter':                      'rgb(255, 73, 68, 0.1)'
	},
	dark:    {
		...
		'slab_modal_header_background':        'rgb(48 85 155)',
